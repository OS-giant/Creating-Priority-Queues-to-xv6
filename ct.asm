...
int main(int argc, char *argv[]) {
  ...
  4b:	3d d0 07 00 00       	cmp    $0x7d0,%eax
  50:	76 13                	jbe    65 <main+0x65>
    printf(2,"Invalid priority (0-20)!\n");
  52:	51                   	push   %ecx
  53:	51                   	push   %ecx
  54:	68 e2 07 00 00       	push   $0x7e2
  59:	6a 02                	push   $0x2
  5b:	e8 00 04 00 00       	call   460 <printf>
    exit();
  60:	e8 7e 02 00 00       	call   2e3 <exit>
  }
  ...
  67:	50                   	push   %eax
  68:	53                   	push   %ebx
  69:	e8 35 03 00 00       	call   3a3 <changeTicket>
  exit();
