...
int main(int argc, char *argv[]){
  ...
  32:	c3                   	ret    
  33:	bb 05 00 00 00       	mov    $0x5,%ebx
            int a = fork();
  38:	e8 ce 02 00 00       	call   30b <fork>
            if (a < 0){
  3d:	85 c0                	test   %eax,%eax
  3f:	78 10                	js     51 <main+0x51>
            else if(a == 0) {
  41:	74 24                	je     67 <main+0x67>
        for (int i = 0 ; i < num_of_processes ; i++){
  43:	83 eb 01             	sub    $0x1,%ebx
  46:	74 de                	je     26 <main+0x26>
            int a = fork();
  48:	e8 be 02 00 00       	call   30b <fork>
            if (a < 0){
  4d:	85 c0                	test   %eax,%eax
  4f:	79 f0                	jns    41 <main+0x41>
                while(wait() != -1){
  51:	e8 c5 02 00 00       	call   31b <wait>
  56:	83 f8 ff             	cmp    $0xffffffff,%eax
  59:	74 e8                	je     43 <main+0x43>
  5b:	e8 bb 02 00 00       	call   31b <wait>
  60:	83 f8 ff             	cmp    $0xffffffff,%eax
  63:	75 ec                	jne    51 <main+0x51>
  65:	eb dc                	jmp    43 <main+0x43>
                while(1) {}
  67:	eb fe                	jmp    67 <main+0x67>
        pid = atoi(argv[1]);
  69:	83 ec 0c             	sub    $0xc,%esp
  6c:	ff 76 04             	pushl  0x4(%esi)
  6f:	e8 2c 02 00 00       	call   2a0 <atoi>
  74:	89 c3                	mov    %eax,%ebx
        priority = atoi(argv[2]);
  76:	58                   	pop    %eax
  77:	ff 76 08             	pushl  0x8(%esi)
  7a:	e8 21 02 00 00       	call   2a0 <atoi>
        if (priority < 0 || priority > 20){
  7f:	83 c4 10             	add    $0x10,%esp
  82:	83 f8 14             	cmp    $0x14,%eax
  85:	76 13                	jbe    9a <main+0x9a>
            printf(2,"Invalid priority (0-20)!\n");
  87:	51                   	push   %ecx
  88:	51                   	push   %ecx
  89:	68 f8 07 00 00       	push   $0x7f8
  8e:	6a 02                	push   $0x2
  90:	e8 fb 03 00 00       	call   490 <printf>
            exit();
  95:	e8 79 02 00 00       	call   313 <exit>
        chpr(pid, priority);
  9a:	52                   	push   %edx
  9b:	52                   	push   %edx
  9c:	50                   	push   %eax
  9d:	53                   	push   %ebx
  9e:	e8 20 03 00 00       	call   3c3 <chpr>
        exit();
  a3:	e8 6b 02 00 00       	call   313 <exit>
  a8:	66 90                	xchg   %ax,%ax
  aa:	66 90                	xchg   %ax,%ax
  ac:	66 90                	xchg   %ax,%ax
  ae:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	eb 1a                	jmp    630 <printf+0x1a0>
          s = "(null)";
 616:	bb 12 08 00 00       	mov    $0x812,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 665:	a1 e0 0a 00 00       	mov    0xae0,%eax
{
...
malloc(uint nbytes)
{
 ...
 6fd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 700:	8b 3d e0 0a 00 00    	mov    0xae0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
